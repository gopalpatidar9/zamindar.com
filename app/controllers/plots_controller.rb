class PlotsController < ApplicationController
  ...
  private
    ...
    def plot_params
      params.require(:plot).permit(:property_type, :city, :locality, :address, :road_width, :plot_area, :transaction_type, :property_availability, :expected_price, :price_per_sqyrd, :corner_plot, :images)
    end
end
